...
from models.dthn import DTHN
from models.seqnet import SeqNet
from models.tbhn import TBHN
from models.trhn import TRHN
...
def main(args):
    ...
    if cfg.MODEL.TRANSFORMER.DTH == [True, True]:
        model = DTHN(cfg)
    elif cfg.MODEL.TRANSFORMER.DTH == [False, True]:
        model = TRHN(cfg)
    elif cfg.MODEL.TRANSFORMER.DTH == [True, False]:
        model = TBHN(cfg)
    elif cfg.MODEL.TRANSFORMER.DTH == [False, False]:
        model = SeqNet(cfg)
    model.to(device)

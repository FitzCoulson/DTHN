...
class TBHN(nn.Module):
    def __init__(self, cfg):
        super(TBHN, self).__init__()
        backbone, reid_head = build_resnet(name="resnet50", pretrained=True)
...
class TBHRoIHeads(RoIHeads):
    def __init__(
        ...
        super(TBHRoIHeads, self).__init__(*args, **kwargs)
        embedding_dim = 256
        self.embedding_head = NormAwareEmbedding(featmap_names=["feat_res4", "feat_res5"],
